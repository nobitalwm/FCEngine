...
void CCamera::GetProjectionMatrix(kmMat4 &mat) const
{
    ...
    case eCT_2D:
        kmMat4OrthographicProjection(&mat, 
            m_vec2CameraCenterOffset.x, m_uWidth + m_vec2CameraCenterOffset.x,
            m_uHeight + m_vec2CameraCenterOffset.y, m_vec2CameraCenterOffset.y,
            m_fZNear, m_fZFar);
        break;
    case eCT_3D:
...
void CCamera::ApplyCameraChange()
{
    ...
    GLint uCurrentShader = pState->GetShaderProgram();
#ifdef _DEBUG
